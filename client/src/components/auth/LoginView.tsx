  ...
  return (
    <div className="mx-auto max-w-md px-4 py-10">
      <div className="glass-card p-6">
        ...
        <p className="mt-2 text-sm text-muted-foreground">Sign in to manage your match and scoring.</p>
        <form onSubmit={handleSubmit} className="mt-6 space-y-4">
          <label className="block">
            ...
            >
              <option className="text-foreground" value="admin">Admin</option>
              <option className="text-foreground" value="visitor">Visitor</option>
            </select>
          </label>
          {role !== 'visitor' && (
            <label className="block">
